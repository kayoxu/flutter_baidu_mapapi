...
class BMFGeocodeSearch {
  ...
  /// 成功返回YES，否则返回false
  Future<bool?> geoCodeSearch(
      BMFGeoCodeSearchOption? geoCodeSearchOption) async {
...
class BMFReverseGeoCodeSearch {
  ...
  void onGetReverseGeoCodeSearchResult(
      {required void Function(BMFReverseGeoCodeSearchResult? result,
              BMFSearchErrorCode? errorCode)
          callback}) {
    _reverseGeoCodeSearchDispatcher
        ?.onGetReverseGeoCodeSearchCallback(callback);
  }
}
