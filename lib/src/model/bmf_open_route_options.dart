...
class BMFOpenRouteOption implements BMFModel {
  ...
  BMFOpenRouteOption.fromMap(Map? map)
      : assert(map != null,
        ...
        assert(map?.containsKey('startCoord') == true),
        assert(map?.containsKey('endCoord') == true),
        assert(map?.containsKey('routeTyp') == true) {
  ...
  Map<String, Object?> toMap() {
    return {
      ...
      'transitPolicy': (this.transitPolicy?.index ?? 0) + 3, // native 初始值为3
